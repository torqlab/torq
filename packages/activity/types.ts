 ...
 */
export type ActivityStravaApiResponse = {
  id: number;
 ...
 */
export type ActivityGuardrails = {
  /**
   ...
   */
  validateActivity: (activity: Activity) => ActivityValidationResult;
};
